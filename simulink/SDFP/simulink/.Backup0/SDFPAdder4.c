...
#define S_FUNCTION_NAME SDFPAdder4
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          4
/* Input Port  0 */
#define IN_PORT_0_NAME      in0
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      adder_out
...
extern void SDFPAdder4_Outputs_wrapper(const uint32_T *in0,
                          const uint32_T *in1,
                          const uint32_T *in2,
                          const uint32_T *in3,
                          uint32_T *adder_out  , 
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SDFPAdder4_Outputs_wrapper(in0, in1, in2, in3, adder_out, in_bitwidth, p_width0, in_fp_position, p_width1, out_bitwidth, p_width2, out_fp_position, p_width3);
}
