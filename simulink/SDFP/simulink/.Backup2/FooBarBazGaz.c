 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Fri Jan 29 14:58:39 2010
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME FooBarBazGaz
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void FooBarBazGaz_Outputs_wrapper(const real_T *u0,
                          const real_T *u1,
                          real_T *y0,
                          real_T *y1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    FooBarBazGaz_Outputs_wrapper(u0, u1, y0, y1);
}
