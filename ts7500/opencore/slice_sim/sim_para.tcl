...
set ::bali::simulation::Para(FILELIST) {"wb_resync.v" "syscon.v" "wb_spi.v" "wb_arbiter.v" "wb_writebuffer.v" "spi_sbus.v" "ts7500_top.v" "tagmem.v" "pll2.v" "pll.v" "coefficient_blockram.v" "coefficient_memwindow.v" "logging_bram.v" "logging_memwindow.v" "adc_buffer.v" "biquad_filter_32bit.v" "wb_biquad_interface_128.v" "sigma_delta_buffer_filter.v" "spi_module.v" "pga_control.v" "lattice_ram_24bit_16word.v" "lattice_ram_36bit_512.v" "slice_sim.v" }
