...
/* Module Version: 5.2 */
/* /usr/local/diamond/1.2/ispfpga/bin/lin/scuba -w -n pll2 -lang verilog -synth synplify -arch mg5a00 -type pll -fin 25 -phase_cntl STATIC -fclkop 100 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -fclkok 50 -fclkok_tol 0.0 -norst -noclkok2 -e  */
/* Mon Apr 16 17:56:26 2012 */


`timescale 1 ns / 1 ps
module pll2 (CLK, CLKOP, CLKOK, LOCK)/* synthesis syn_noprune=1 */;// exemplar attribute pll2 dont_touch true 
    input wire CLK;
    output wire CLKOP;
    output wire CLKOK;
    output wire LOCK;
    ...
    EPLLD1 PLLInst_0 (.CLKI(CLK), .CLKFB(CLKOP_t), .RST(scuba_vlo), .RSTK(scuba_vlo), 
        ...
        .CLKOK(CLKOK), .LOCK(LOCK), .CLKINTFB())
