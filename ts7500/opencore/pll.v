...
/* Module Version: 5.2 */
/* /usr/local/diamond/1.2/ispfpga/bin/lin/scuba -w -n pll -lang verilog -synth synplify -arch mg5a00 -type pll -fin 25 -phase_cntl DYNAMIC -trimp 0 -fclkop 75 -fclkop_tol 0.0 -fb_mode INTERNAL -duty50 -fdel 1 -fclkok .75 -fclkok_tol 0.0 -norst -noclkok2 -e  */
/* Mon Sep 26 11:39:03 2011 */


`timescale 1 ns / 1 ps
module pll (CLK, WRDEL, DPHASE0, DPHASE1, DPHASE2, DPHASE3, CLKOP, CLKOS, 
    CLKOK, LOCK)/* synthesis syn_noprune=1 */;// exemplar attribute pll dont_touch true 
    input wire CLK;
    input wire WRDEL;
    input wire DPHASE0;
    input wire DPHASE1;
    ...
    defparam PLLInst_0.CLKOK_DIV = 100 ;
    ...
    EHXPLLE1 PLLInst_0 (.CLKI(CLK), .CLKFB(CLKFB_t), .RST(scuba_vlo), .RSTK(scuba_vlo), 
        ...
        .CLKOK(CLKOK), .CLKOK2(), .LOCK(LOCK), .CLKINTFB(CLKFB_t))
             ...
             /* synthesis FREQUENCY_PIN_CLKOK="0.750000" */
             /* synthesis CLKOK_DIV="100" */
    ...
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOK 0.750000
    // exemplar attribute PLLInst_0 CLKOK_DIV 100
