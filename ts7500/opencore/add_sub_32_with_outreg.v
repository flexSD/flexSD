...
/* Module Version: 3.1 */
/* /usr/local/diamond/1.2/ispfpga/bin/lin/scuba -w -lang verilog -synth synplify -bus_exp 7 -bb -arch mg5a00 -type addsub -width 32 -signed -port overflow -output_reg -enable -pipeline 0 -e  */
/* Thu Jun  7 09:50:09 2012 */


`timescale 1 ns / 1 ps
module add_sub_32_with_outreg (DataA, DataB, Add_Sub, Clock, Reset, 
    ClockEn, Result, Overflow);
    ...
    XNOR2 XNOR2_t1 (.A(Add_Sub), .B(DataB[31]), .Z(t_bn));
    ...
    FD1P3DX FF_33 (.D(tco_n_1), .SP(ClockEn), .CK(Clock), .CD(Reset), .Q(r0_co_n_1))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_32.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_32 (.D(tsum30), .SP(ClockEn), .CK(Clock), .CD(Reset), .Q(r0_sum30))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_31.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_31 (.D(tsum29), .SP(ClockEn), .CK(Clock), .CD(Reset), .Q(r0_sum29))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_30.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_30 (.D(tsum28), .SP(ClockEn), .CK(Clock), .CD(Reset), .Q(r0_sum28))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_29.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_29 (.D(tsum27), .SP(ClockEn), .CK(Clock), .CD(Reset), .Q(r0_sum27))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_28.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_28 (.D(tsum26), .SP(ClockEn), .CK(Clock), .CD(Reset), .Q(r0_sum26))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_27.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_27 (.D(tsum25), .SP(ClockEn), .CK(Clock), .CD(Reset), .Q(r0_sum25))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_26.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_26 (.D(tsum24), .SP(ClockEn), .CK(Clock), .CD(Reset), .Q(r0_sum24))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_25.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_25 (.D(tsum23), .SP(ClockEn), .CK(Clock), .CD(Reset), .Q(r0_sum23))
             /* synthesis GSR="ENABLED" */;
    ...
    // synopsys translate_on
    FD1P3DX FF_1 (.D(sum31_r1), .SP(ClockEn), .CK(Clock), .CD(Reset), .Q(Result[31]))
             /* synthesis GSR="ENABLED" */;
    ...
    FADSU2 addsub_12 (.A0(DataA[23]), .A1(DataA[24]), .B0(DataB[23]), .B1(DataB[24]), 
        .BCI(co11), .CON(Add_Sub), .BCO(co12), .S0(tsum23), .S1(tsum24));

    FADSU2 addsub_13 (.A0(DataA[25]), .A1(DataA[26]), .B0(DataB[25]), .B1(DataB[26]), 
        .BCI(co12), .CON(Add_Sub), .BCO(co13), .S0(tsum25), .S1(tsum26));

    FADSU2 addsub_14 (.A0(DataA[27]), .A1(DataA[28]), .B0(DataB[27]), .B1(DataB[28]), 
        .BCI(co13), .CON(Add_Sub), .BCO(co14), .S0(tsum27), .S1(tsum28));

    FADSU2 addsub_15 (.A0(DataA[29]), .A1(DataA[30]), .B0(DataB[29]), .B1(DataB[30]), 
        .BCI(co14), .CON(Add_Sub), .BCO(co15), .S0(tsum29), .S1(tsum30));

    FADSU2 addsub_16 (.A0(scuba_vlo), .A1(Add_Sub), .B0(add_sub_inv), .B1(scuba_vlo), 
        .BCI(co15), .CON(Add_Sub), .BCO(), .S0(tco_n_1), .S1());

    FADD2B addsub_o0 (.A0(tco_n_1), .A1(DataA[31]), .B0(tco_n_1), .B1(t_bn), 
        .CI(scuba_vlo), .COUT(co_n_t), .S0(), .S1(sum31_r1));
