...
/* Module Version: 3.5 */
/* /usr/local/diamond/1.2/ispfpga/bin/lin/scuba -w -lang verilog -synth synplify -bus_exp 7 -bb -arch mg5a00 -type sdpram -rdata_width 32 -data_width 32 -num_rows 16 -outData REGISTERED -e  */
/* Thu Jun  7 09:59:39 2012 */


`timescale 1 ns / 1 ps
module lattice_ram_32bit_16 (WrAddress, Data, WrClock, WE, WrClockEn, 
    ...
    // synopsys translate_on
    DPR16X4B mem_0_0 (.DI0(Data[28]), .DI1(Data[29]), .DI2(Data[30]), .DI3(Data[31]), 
        ...
        .DO1(dataout29_ffin), .DO2(dataout30_ffin), .DO3(dataout31_ffin))
             ...
             /* synthesis MEM_LPC_FILE="lattice_ram_32bit_16.lpc" */
    ...
    // synopsys translate_on
    DPR16X4B mem_0_1 (.DI0(Data[24]), .DI1(Data[25]), .DI2(Data[26]), .DI3(Data[27]), 
        .WCK(WrClock), .WRE(dec0_wre3), .RAD0(RdAddress[0]), .RAD1(RdAddress[1]), 
        .RAD2(RdAddress[2]), .RAD3(RdAddress[3]), .WAD0(WrAddress[0]), .WAD1(WrAddress[1]), 
    ...
    // synopsys translate_on
    DPR16X4B mem_0_2 (.DI0(Data[20]), .DI1(Data[21]), .DI2(Data[22]), .DI3(Data[23]), 
        .WCK(WrClock), .WRE(dec0_wre3), .RAD0(RdAddress[0]), .RAD1(RdAddress[1]), 
        .RAD2(RdAddress[2]), .RAD3(RdAddress[3]), .WAD0(WrAddress[0]), .WAD1(WrAddress[1]), 
    ...
    // synopsys translate_on
    DPR16X4B mem_0_3 (.DI0(Data[16]), .DI1(Data[17]), .DI2(Data[18]), .DI3(Data[19]), 
        .WCK(WrClock), .WRE(dec0_wre3), .RAD0(RdAddress[0]), .RAD1(RdAddress[1]), 
        .RAD2(RdAddress[2]), .RAD3(RdAddress[3]), .WAD0(WrAddress[0]), .WAD1(WrAddress[1]), 
    ...
    // synopsys translate_on
    DPR16X4B mem_0_4 (.DI0(Data[12]), .DI1(Data[13]), .DI2(Data[14]), .DI3(Data[15]), 
        .WCK(WrClock), .WRE(dec0_wre3), .RAD0(RdAddress[0]), .RAD1(RdAddress[1]), 
        .RAD2(RdAddress[2]), .RAD3(RdAddress[3]), .WAD0(WrAddress[0]), .WAD1(WrAddress[1]), 
    ...
    // synopsys translate_on
    DPR16X4B mem_0_5 (.DI0(Data[8]), .DI1(Data[9]), .DI2(Data[10]), .DI3(Data[11]), 
        .WCK(WrClock), .WRE(dec0_wre3), .RAD0(RdAddress[0]), .RAD1(RdAddress[1]), 
        .RAD2(RdAddress[2]), .RAD3(RdAddress[3]), .WAD0(WrAddress[0]), .WAD1(WrAddress[1]), 
    ...
    // synopsys translate_on
    DPR16X4B mem_0_6 (.DI0(Data[4]), .DI1(Data[5]), .DI2(Data[6]), .DI3(Data[7]), 
        .WCK(WrClock), .WRE(dec0_wre3), .RAD0(RdAddress[0]), .RAD1(RdAddress[1]), 
        .RAD2(RdAddress[2]), .RAD3(RdAddress[3]), .WAD0(WrAddress[0]), .WAD1(WrAddress[1]), 
    ...
    // synopsys translate_on
    DPR16X4B mem_0_7 (.DI0(Data[0]), .DI1(Data[1]), .DI2(Data[2]), .DI3(Data[3]), 
        .WCK(WrClock), .WRE(dec0_wre3), .RAD0(RdAddress[0]), .RAD1(RdAddress[1]), 
        .RAD2(RdAddress[2]), .RAD3(RdAddress[3]), .WAD0(WrAddress[0]), .WAD1(WrAddress[1]), 
    ...
    // exemplar attribute mem_0_0 MEM_LPC_FILE lattice_ram_32bit_16.lpc
    ...
    // exemplar attribute mem_0_1 MEM_LPC_FILE lattice_ram_32bit_16.lpc
    ...
    // exemplar attribute mem_0_2 MEM_LPC_FILE lattice_ram_32bit_16.lpc
    ...
    // exemplar attribute mem_0_3 MEM_LPC_FILE lattice_ram_32bit_16.lpc
    ...
    // exemplar attribute mem_0_4 MEM_LPC_FILE lattice_ram_32bit_16.lpc
    ...
    // exemplar attribute mem_0_5 MEM_LPC_FILE lattice_ram_32bit_16.lpc
    ...
    // exemplar attribute mem_0_6 MEM_LPC_FILE lattice_ram_32bit_16.lpc
    ...
    // exemplar attribute mem_0_7 MEM_LPC_FILE lattice_ram_32bit_16.lpc
